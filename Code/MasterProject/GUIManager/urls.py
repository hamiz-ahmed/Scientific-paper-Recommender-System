...
urlpatterns = [
    ...
    url(r'^logout/$', auth_views.logout,
        {'template_name': 'GUIManager/logout.html'}, name='logout'),
    ...
    url(r'^modify_algorithm/(?P<algorithm_id>[0-9]+)/$',
        views.update_algorithm, name='update_algorithm'),
    url(r'^delete_algorithm/(?P<algorithm_id>[0-9]+)/$',
        views.delete_algorithm, name='delete_algorithm'),
    url(r'^search/$', views.search, name='search'),
    url(r'^add_feedback/$', views.process_feedback, name='process_feedback'),
    url(r'^register/$', views.register, name='register'),
    url(r'^displayrecommendation/$', views.getrecommendation,
    ...
    url(r'^eval_manager/$', views.show_feedback_rating,
        name='feedback_ratings'),
    url(r'^convert_feedback/$', views.convert_feedback_rating,
        name='convert_feedback'),
    url(r'^update_system_rec/$', views.update_system_recommendation,
        name='update_system_rec')
